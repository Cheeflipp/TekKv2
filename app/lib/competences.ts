export const competences = [
  ...
  { 
    id: 5, 
    title: 'Svejsning og Montage', 
    desc: 'Erfaring med TIG svejsning, pladebearbejdning og montage. Jeg træder til som ekstra arbejdskraft, når I mangler hænder til at sikre solide løsninger.',
    bullets: ['TIG Svejsning', 'Pladebearbejdning', 'Montage']
  },
  { 
    id: 6, 
    title: 'Konstruktion og Dimensionering', 
    desc: 'Solid teknisk forståelse for mekanisk design. Jeg hjælper med at sikre, at komponenter og anlæg er korrekt dimensioneret og overholder alle nødvendige tolerancer og kvalitetskrav.', 
    bullets: ['Toleranceberegninger', 'Dimensionering af anlæg', 'Materialeforståelse'] 
  },
  { 
    id: 7, 
    title: 'Lager og Logistik', 
    desc: 'Effektiv håndtering af varer, modtagelse og system i tingene. Jeg holder overblikket og tager fat i travle perioder.',
